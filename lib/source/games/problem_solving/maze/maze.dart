...
class MazeDashBoard extends StatefulWidget {
  ...
  @override
  State<MazeDashBoard> createState() => _MazeDashBoardState();
}

class _MazeDashBoardState extends State<MazeDashBoard> {
 ...
 // Variable to store the elapsed time
  ...
  child: 
      Maze(
        ...
        saveTimeData(counter, "level1","25");
        navPop(context);
          showDialog(
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const MazeMedium()),
                            );
                          },
